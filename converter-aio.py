...
def main():
    ...
    if args.skip_convert:
        ...
        if has_videos:
            ...
            print_log("Check that music videos are correctly identified and formatted (compare metadata original vs matched track and artist name).")
            ...
            cmd = f"python converter.py --file {sanitized_videos}"
